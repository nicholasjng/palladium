...
atom, same as any other jaxpr value. Positive-stride slices and partial
dimensions compose with the Ref's physical storage addressing.
"""
...
def test_noncontiguous_kept_dims():
    ...
    np.testing.assert_array_equal(f(x), x[:, :, 0:1])
