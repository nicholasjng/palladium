    ...
    uint3 _pid [[thread_position_in_grid]])
{
    ...
    for (uint _i1 = 0; _i1 < 1; ++_i1) {
        t0[_i1] = arg2_offset[_i1];
    }
    float t2[1];
    for (uint _i3 = 0; _i3 < 1; ++_i3) {
        t2[_i3] = arg3_offset[_i3];
    }
    float t4[1];
    for (uint _i5 = 0; _i5 < 1; ++_i5) {
        t4[_i5] = arg4_offset[_i5];
    }
    float t6[1];
    for (uint _i7 = 0; _i7 < 1; ++_i7) {
        t6[_i7] = arg5_offset[_i7];
    }
    float t8[1];
    for (uint _i9 = 0; _i9 < 1; ++_i9) {
        t8[_i9] = arg0_offset[_i9];
    }
    float t10[1];
    for (uint _i11 = 0; _i11 < 1; ++_i11) {
        t10[_i11] = arg1_offset[_i11];
    }
    float t12[1];
    ...
    for (uint _i136 = 0; _i136 < 1; ++_i136) {
        arg6_offset[_i136] = t12[_i136];
    }
    for (uint _i137 = 0; _i137 < 1; ++_i137) {
        arg7_offset[_i137] = t14[_i137];
    }
}
