...
def test_euler_logistic(rng):
    ...
    f = palladium.metal_call(kernel, out_shape=jax.ShapeDtypeStruct((1024,), jnp.float32))
...
def test_nested_loops(rng):
    ...
    f = palladium.metal_call(kernel, out_shape=jax.ShapeDtypeStruct((128,), jnp.float32))
